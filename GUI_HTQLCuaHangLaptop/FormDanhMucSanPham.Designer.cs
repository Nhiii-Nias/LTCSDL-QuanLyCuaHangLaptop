namespace GUI_HTQLCuaHangLaptop
{
    partial class FormDanhMucSanPham
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBoxChucNang.Items.AddRange(new object[] { "Quản lý hãng sản xuất", "Quản lý loại sản phẩm", "Quản lý cấu hình" });
