...
namespace GUI_HTQLCuaHangLaptop
{
    public partial class FormDanhMucSanPham : Form
    {
        ...
        public FormDanhMucSanPham(DTO_TaiKhoanNV taiKhoan)
        {
        ...
        private void comboBoxChucNang_SelectedIndexChanged(object? sender, EventArgs e)
        {
            ...
            {
                case 0:
                    MoFormCon(new FormHangSanXuat());
                    break;
                case 1:
                    MoFormCon(new FormLoaiSanPham(_taiKhoanHienTai.MaVaiTro));
                    break;
                case 2:
                    MoFormCon(new FormCauHinh());
                    break;
            }
        }
